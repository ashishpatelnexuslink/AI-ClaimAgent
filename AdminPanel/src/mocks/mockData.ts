...
export const mockClaims: Claim[] = [
  { id: '1', claimNumber: 'CLM-77129-AZ', userId: '1', userName: 'David Smith', type: 'Accident', status: 'Under Review', vehicleReg: 'MH 12 AB 3456', incidentDate: '2026-01-12', submittedAt: '2026-01-13', updatedAt: '2026-01-15', description: 'Rear-end collision at traffic signal. Bumper and tail lights damaged.', photos: ['/photos/1a.jpg', '/photos/1b.jpg'], claimantType: 'Policy Holder', amount: 45000, assignedTo: 'John Admin' },
  { id: '2', claimNumber: 'CLM-77130-TX', userId: '2', userName: 'Sarah Johnson', type: 'Theft', status: 'Pending', vehicleReg: 'DL 05 CD 7890', incidentDate: '2026-01-15', submittedAt: '2026-01-16', updatedAt: '2026-01-16', description: 'Vehicle stolen from parking lot overnight. Police report filed.', photos: ['/photos/2a.jpg'], claimantType: 'Policy Holder', amount: 320000 },
  { id: '3', claimNumber: 'CLM-77131-CA', userId: '3', userName: 'Mike Brown', type: 'Natural Disaster', status: 'Approved', vehicleReg: 'KA 01 EF 1234', incidentDate: '2026-01-10', submittedAt: '2026-01-11', updatedAt: '2026-01-14', description: 'Flood damage during heavy rains. Engine and interiors waterlogged.', photos: ['/photos/3a.jpg', '/photos/3b.jpg', '/photos/3c.jpg'], claimantType: 'Policy Holder', amount: 125000, assignedTo: 'Lisa Reviewer' },
  { id: '4', claimNumber: 'CLM-77132-NY', userId: '4', userName: 'Emily Davis', type: 'Vandalism', status: 'Rejected', vehicleReg: 'TN 09 GH 5678', incidentDate: '2026-01-08', submittedAt: '2026-01-09', updatedAt: '2026-01-12', description: 'Windshield smashed and paint scratched in apartment parking.', photos: ['/photos/4a.jpg'], claimantType: 'Policy Holder', amount: 18000 },
  { id: '5', claimNumber: 'CLM-77133-FL', userId: '5', userName: 'James Wilson', type: 'Accident', status: 'Approved', vehicleReg: 'GJ 06 IJ 9012', incidentDate: '2026-01-20', submittedAt: '2026-01-21', updatedAt: '2026-01-25', description: 'Side collision at intersection. Door panel and mirror damaged.', photos: ['/photos/5a.jpg', '/photos/5b.jpg'], claimantType: 'Third-party', amount: 67000, assignedTo: 'John Admin' },
  { id: '6', claimNumber: 'CLM-77134-WA', userId: '6', userName: 'Olivia Martinez', type: 'Theft', status: 'Pending', vehicleReg: 'RJ 14 KL 3456', incidentDate: '2026-02-01', submittedAt: '2026-02-02', updatedAt: '2026-02-02', description: 'Accessories stolen from parked car. Side window broken.', photos: [], claimantType: 'Policy Holder', amount: 25000 },
  { id: '7', claimNumber: 'CLM-77135-IL', userId: '7', userName: 'William Taylor', type: 'Accident', status: 'Under Review', vehicleReg: 'UP 32 MN 7890', incidentDate: '2026-02-05', submittedAt: '2026-02-06', updatedAt: '2026-02-08', description: 'Multi-vehicle pileup on highway. Front bumper and hood crumpled.', photos: ['/photos/7a.jpg', '/photos/7b.jpg'], claimantType: 'Policy Holder', amount: 95000, assignedTo: 'Lisa Reviewer' },
  { id: '8', claimNumber: 'CLM-77136-OH', userId: '8', userName: 'Sophia Anderson', type: 'Natural Disaster', status: 'Approved', vehicleReg: 'MP 04 OP 1234', incidentDate: '2026-02-10', submittedAt: '2026-02-11', updatedAt: '2026-02-15', description: 'Hailstorm damage. Multiple dents on roof and hood.', photos: ['/photos/8a.jpg'], claimantType: 'Policy Holder', amount: 42000, assignedTo: 'John Admin' },
  { id: '9', claimNumber: 'CLM-77137-GA', userId: '9', userName: 'Alexander Thomas', type: 'Vandalism', status: 'Pending', vehicleReg: 'HR 26 QR 5678', incidentDate: '2026-02-12', submittedAt: '2026-02-13', updatedAt: '2026-02-13', description: 'Key scratches along both sides of the vehicle.', photos: ['/photos/9a.jpg'], claimantType: 'Policy Holder', amount: 15000 },
  { id: '10', claimNumber: 'CLM-77138-NC', userId: '10', userName: 'Isabella Jackson', type: 'Accident', status: 'Rejected', vehicleReg: 'WB 06 ST 9012', incidentDate: '2026-02-18', submittedAt: '2026-02-19', updatedAt: '2026-02-22', description: 'Minor fender bender. Claim rejected due to expired policy.', photos: [], claimantType: 'Third-party', amount: 12000 },
  { id: '11', claimNumber: 'CLM-77139-MI', userId: '1', userName: 'David Smith', type: 'Theft', status: 'Approved', vehicleReg: 'MH 12 AB 3456', incidentDate: '2026-03-01', submittedAt: '2026-03-02', updatedAt: '2026-03-05', description: 'Catalytic converter stolen. Replacement required.', photos: ['/photos/11a.jpg'], claimantType: 'Policy Holder', amount: 55000, assignedTo: 'Lisa Reviewer' },
  { id: '12', claimNumber: 'CLM-77140-PA', userId: '2', userName: 'Sarah Johnson', type: 'Accident', status: 'Pending', vehicleReg: 'DL 05 CD 7890', incidentDate: '2026-03-05', submittedAt: '2026-03-06', updatedAt: '2026-03-06', description: 'Rear collision while reversing. Bumper cracked.', photos: ['/photos/12a.jpg'], claimantType: 'Policy Holder', amount: 22000 },
  { id: '13', claimNumber: 'CLM-77141-NJ', userId: '3', userName: 'Mike Brown', type: 'Natural Disaster', status: 'Under Review', vehicleReg: 'KA 01 EF 1234', incidentDate: '2026-03-10', submittedAt: '2026-03-11', updatedAt: '2026-03-13', description: 'Cyclone damage. Tree fell on the vehicle roof.', photos: ['/photos/13a.jpg', '/photos/13b.jpg'], claimantType: 'Policy Holder', amount: 180000, assignedTo: 'John Admin' },
  { id: '14', claimNumber: 'CLM-77142-VA', userId: '4', userName: 'Emily Davis', type: 'Accident', status: 'Approved', vehicleReg: 'TN 09 GH 5678', incidentDate: '2026-03-15', submittedAt: '2026-03-16', updatedAt: '2026-03-20', description: 'T-bone collision at crossroads. Major door damage.', photos: ['/photos/14a.jpg'], claimantType: 'Third-party', amount: 78000, assignedTo: 'Lisa Reviewer' },
  { id: '15', claimNumber: 'CLM-77143-MA', userId: '5', userName: 'James Wilson', type: 'Vandalism', status: 'Pending', vehicleReg: 'GJ 06 IJ 9012', incidentDate: '2026-03-20', submittedAt: '2026-03-21', updatedAt: '2026-03-21', description: 'Tires slashed in public parking area.', photos: ['/photos/15a.jpg'], claimantType: 'Policy Holder', amount: 20000 },
  { id: '16', claimNumber: 'CLM-77144-AZ', userId: '6', userName: 'Olivia Martinez', type: 'Accident', status: 'Approved', vehicleReg: 'RJ 14 KL 3456', incidentDate: '2026-03-25', submittedAt: '2026-03-26', updatedAt: '2026-03-30', description: 'Head-on collision on narrow road. Radiator and front axle damaged.', photos: ['/photos/16a.jpg', '/photos/16b.jpg'], claimantType: 'Policy Holder', amount: 150000, assignedTo: 'John Admin' },
  { id: '17', claimNumber: 'CLM-77145-TX', userId: '7', userName: 'William Taylor', type: 'Theft', status: 'Rejected', vehicleReg: 'UP 32 MN 7890', incidentDate: '2026-04-01', submittedAt: '2026-04-02', updatedAt: '2026-04-05', description: 'Claimed theft but CCTV shows no evidence. Claim denied.', photos: [], claimantType: 'Policy Holder', amount: 280000 },
  { id: '18', claimNumber: 'CLM-77146-CA', userId: '8', userName: 'Sophia Anderson', type: 'Natural Disaster', status: 'Pending', vehicleReg: 'MP 04 OP 1234', incidentDate: '2026-04-05', submittedAt: '2026-04-06', updatedAt: '2026-04-06', description: 'Lightning strike damaged vehicle electronics.', photos: ['/photos/18a.jpg'], claimantType: 'Policy Holder', amount: 35000 },
  { id: '19', claimNumber: 'CLM-77147-NY', userId: '9', userName: 'Alexander Thomas', type: 'Accident', status: 'Under Review', vehicleReg: 'HR 26 QR 5678', incidentDate: '2026-04-10', submittedAt: '2026-04-11', updatedAt: '2026-04-13', description: 'Rollover accident on curved road. Extensive body damage.', photos: ['/photos/19a.jpg', '/photos/19b.jpg', '/photos/19c.jpg'], claimantType: 'Policy Holder', amount: 210000, assignedTo: 'Lisa Reviewer' },
  { id: '20', claimNumber: 'CLM-77148-FL', userId: '10', userName: 'Isabella Jackson', type: 'Vandalism', status: 'Approved', vehicleReg: 'WB 06 ST 9012', incidentDate: '2026-04-12', submittedAt: '2026-04-13', updatedAt: '2026-04-16', description: 'Spray paint vandalism on entire vehicle body.', photos: ['/photos/20a.jpg'], claimantType: 'Policy Holder', amount: 30000, assignedTo: 'John Admin' },
];
...
export const mockConversations: Conversation[] = [
  ...
  { id: '3', threadId: 'THR-003', userId: '3', userName: 'Mike Brown', mode: 'Chat', startedAt: '2026-04-14T14:20:00Z', endedAt: '2026-04-14T14:23:00Z', duration: 180, messageCount: 6, claimId: '3', status: 'Completed', chatJsonPath: '/uploads/transcripts/THR-003.json', messages: [
    ...
    { id: 'm3', type: 'bot', content: 'Congratulations! Your claim CLM-77131-CA has been approved for ₹1,25,000. Payment will be processed within 5 business days.', timestamp: '2026-04-14T14:20:35Z' },
  ] },
