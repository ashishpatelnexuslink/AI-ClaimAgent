...
public class CreateDocumentSettingValidator : AbstractValidator<CreateDocumentSettingDto>
{
    public CreateDocumentSettingValidator()
    {
        RuleFor(x => x.DocKey)
            .NotEmpty().WithMessage("Document key is required.")
            .MaximumLength(60);

        RuleFor(x => x.Label)
            .NotEmpty().WithMessage("Document label is required.")
            .MaximumLength(150);
